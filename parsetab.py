...
_lr_productions = [
  ...
  ('instrucciones -> instruccion instrucciones','instrucciones',2,'p_instrucciones_lista','analizadorSintactico.py',17),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones_lista','analizadorSintactico.py',18),
  ('instruccion -> OPERAR ACOR expresion CCOR FINAL','instruccion',5,'p_instrucciones_operar','analizadorSintactico.py',22),
  ('instruccion -> expresion','instruccion',1,'p_instrucciones_expr','analizadorSintactico.py',28),
  ('expresion -> expresion SUM expresion','expresion',3,'p_expresion_binaria','analizadorSintactico.py',32),
  ('expresion -> expresion RES expresion','expresion',3,'p_expresion_binaria','analizadorSintactico.py',33),
  ('expresion -> expresion MULT expresion','expresion',3,'p_expresion_binaria','analizadorSintactico.py',34),
  ('expresion -> expresion DIV expresion','expresion',3,'p_expresion_binaria','analizadorSintactico.py',35),
  ('expresion -> expresion POT expresion','expresion',3,'p_expresion_binaria','analizadorSintactico.py',36),
  ('expresion -> RES expresion','expresion',2,'p_expresion_unaria','analizadorSintactico.py',46),
  ('expresion -> APARENT expresion CPARENT','expresion',3,'p_expresion_agrupacion','analizadorSintactico.py',50),
  ('expresion -> NUMERO','expresion',1,'p_expresion_number','analizadorSintactico.py',55),
  ('expresion -> DECIMAL','expresion',1,'p_expresion_number','analizadorSintactico.py',56),
]
